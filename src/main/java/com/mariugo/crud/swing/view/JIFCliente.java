 ...
 */
package com.mariugo.crud.swing.view;

import com.mariugo.crud.swing.data.ClienteData;
...
public class JIFCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTbClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Sobrenome", "E-mail", "Telefone", "CPF"
            }
        ) {
    ...
    private void jTPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTPesquisaKeyReleased
        try {
            ...
            listaCliente = DAO.pesquisar(jTPesquisa.getText());
            listaCliente.forEach((c) -> {
                defaultTableModel.addRow(new String[]{String.valueOf(c.getId()), c.getNome(),
                    c.getSobrenome(), c.getEmail(), c.getTelefone(), c.getCpf()});
            });
            } else {
                limparCampos();
            }
    ...
    private void jTbClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTbClientesMouseClicked
        try {
            ...
            if (linha > -1) {
                jLID.setText(String.valueOf(listaCliente.get(jTbClientes.getSelectedRow()).getId()));
                jTNome.setText(listaCliente.get(jTbClientes.getSelectedRow()).getNome());
                jTSobrenome.setText(listaCliente.get(jTbClientes.getSelectedRow()).getSobrenome());
                jTEmail.setText(listaCliente.get(jTbClientes.getSelectedRow()).getEmail());
                jFTTelefone.setText(listaCliente.get(jTbClientes.getSelectedRow()).getTelefone());
                jFTCPF.setText(listaCliente.get(jTbClientes.getSelectedRow()).getCpf());
